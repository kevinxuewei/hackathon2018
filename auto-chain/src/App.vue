...
<script>
import { AlertModule, Radio, Group, Cell, Badge, Drawer, Actionsheet, ButtonTab, ButtonTabItem, ViewBox, XHeader, Tabbar, TabbarItem, Loading, TransferDom } from 'vux'
...
export default {
  ...
  mounted () {
    ...
    this.handler = () => {
      ...
      if (self.path === '/demo') {
        self.box = document.querySelector('#demo_list_box')
        self.updateDemoPosition(self.box.scrollTop)
      }
    }
  },
  beforeDestroy () {
